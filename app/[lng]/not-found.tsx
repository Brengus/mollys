...
export default function NotFound() {
    return (
        <div className="min-h-[80vh] flex flex-col items-center justify-center bg-[#f5f3ef] px-4 text-center">
            ...
            <h1 className="text-4xl font-extrabold text-[#3d3d3d] mb-4 tracking-tight">404 - Paws Not Found</h1>
            <p className="text-[#8b8b8b] mb-8 text-lg max-w-sm">We searched everywhere, but we couldn&apos;t find the page you were looking for. Maybe it ran off to the park?</p>
            <Link
                href="/"
